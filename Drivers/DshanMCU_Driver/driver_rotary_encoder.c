 ...
 * PF6  - Key
 */
#define ROTARY_ENCODER_S1_GPIO_GROUP GPIOF
#define ROTARY_ENCODER_S1_GPIO_PIN   GPIO_PIN_8

#define ROTARY_ENCODER_S2_GPIO_GROUP GPIOF
#define ROTARY_ENCODER_S2_GPIO_PIN   GPIO_PIN_7

#define ROTARY_ENCODER_KEY_GPIO_GROUP GPIOF
...
{
    /* PF6,PF7在MX_GPIO_Init中被配置为输入引脚 */
    /* PF8在MX_GPIO_Init中被配置为中断引脚,上升沿触发 */
}
